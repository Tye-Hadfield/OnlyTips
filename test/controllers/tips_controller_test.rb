...
class TipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tip" do
    assert_difference('Tip.count') do
      post tips_url, params: { tip: { horse_id: @tip.horse_id, race_course_id: @tip.race_course_id, race_id: @tip.race_id, result: @tip.result, user_id: @tip.user_id } }
    end
  ...
  test "should update tip" do
    patch tip_url(@tip), params: { tip: { horse_id: @tip.horse_id, race_course_id: @tip.race_course_id, race_id: @tip.race_id, result: @tip.result, user_id: @tip.user_id } }
